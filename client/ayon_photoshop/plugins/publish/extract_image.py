...
class ExtractImage(
            ...
            for instance in filtered_instances:
                ...
                with photoshop.isolated_layers_visibility(stub, instance_id, all_layers):
                    ...
                    for extension in self.formats:
                        ...
                        if extension == "exr":
                            self._save_image_to_workfile_extension(
    ...
    def _save_image_to_workfile_extension(self, stub, full_filename, extension, workfile_extension):
        """Hacky way to save image. Save the psd file
        in quiet mode with targa options first and then convert it into desired format.
        ***Caution to use it.
